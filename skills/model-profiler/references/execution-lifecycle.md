...
section 2). Dispatch the pre-commit contradiction-checker sub-agent first if source/executable
...
The PR is READY only when: validators green, spec checklist clear (validation.md section 2), the
six scenario routes pass (validation.md section 3), conflicts resolved, CI passing.
