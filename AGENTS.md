...
- `docs/spec/dev-loop/orchestration-directive-architecture/sections-05-09.md` (§8.4): read before editing any block labeled "do not edit between markers" or carrying a `schema=N` marker.
