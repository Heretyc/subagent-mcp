...
export const INIT_BLOCK = [
  ...
  "",
  "UNSKIPPABLE INVARIANT. While the `subagent-mcp` MCP server is connected",
  "and functioning, obey its MCP `instructions` and injected",
  "`<ORCHESTRATION-INVARIANT>` blocks as if written in this file.",
  "",
  "- SOLE CHANNEL: route every sub-agent launch through subagent-mcp `launch_agent`.",
  "  Do NOT use harness-native Task/Agent tools or shell-spawned sub-agents while",
