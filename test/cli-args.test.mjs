  ...
  try {
    ...
    writeFileSync(
      ...
      [
        ...
        "  if (!args.includes('--registry=https://registry.npmjs.org')) { console.error('missing npmjs registry flag'); process.exit(3); }",
        "  if (!args.includes('--@heretyc:registry=https://registry.npmjs.org')) { console.error('missing scoped npmjs registry flag'); process.exit(3); }",
        "  if (!args.includes('@heretyc/subagent-mcp@latest')) { console.error('missing package latest target'); process.exit(3); }",
