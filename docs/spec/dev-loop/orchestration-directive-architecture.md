...
guard, see `sections-05-09.md` §6.3; it does **not** make a launched child's
...
|---|---|---|---|
| `orchestration-directive-architecture/sections-00-04.md` | §0 layering/redundancy, §1 single tag schema, §2 precedence/joint-binding, §3 ON model, §4 OFF model | you need the tag schema, ON/OFF operating model, or precedence rules | you only need marker/persistence or test mechanics |
...
- joint binding, escalate-to-user, tag > user request → `sections-00-04.md` (§2); verbatim clause → `appendix-a1-a4.md` (A4)
